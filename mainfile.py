...
# Video capture
cap = cv2.VideoCapture(r'carPark.mp4') #change this according to your video path

# Load rectangle box positions
with open(r'CarParkPos', 'rb') as f: #change this according to your pickle file path
